    ...
    <div className="projects" id="projects">
      ...
      <div className="pcards">
        ...
        <div className="pinf">
          ...
          <p>
            {" "}
            We've cloned a Cricbuzz is an Indian cricket news website, It
            features, news, articles and live coverage of cricket matches
            including videos, text commentary, player stats and team rankings.
          </p>
          ...
          <h4>Tech Stack</h4>
          <p>
            HTML5 , CSS3 , Javascript(ES6) , MongoDB , React , React-Reudx ,
            Express JS , Mongoose , Material UI{" "}
          </p>
        ...
        <div className="pinf">
          ...
          <div className="card_btn">
            <button>
              <a
                target="_blank"
                href="https://aadityaneve.github.io/Clone-Pluralsight"
              >
                DEMO
              </a>
            </button>
