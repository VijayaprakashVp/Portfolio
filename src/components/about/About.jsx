      ...
      <div className="about">
        ...
        <div className="parCont">
          <div className="para">
            ...
            using my technical knowledge and skills. I am always curious about
            learning new technologies, and love to develop scalable web
            applications.
            <br />
            <br />
